...
class Scrape:
    ...
    for SearchPickUpTimes in pickuptimes:
        for SearchDropoffTimes in dropofftimes:
            ...
            pickupstationid = content[favorite_pickup]["id"]
            returnstationid = content[favorite_dropoff]["id"]
            ...
            for x in offers:
                ...
                imgurl = offer_content["offers"][nummer]["vehicleGroupInfo"]["modelExample"]["imageUrl"]
                ...
                data.append(
                    {"cartype": car_type, "bookingclass": acrisscode, "cardescription": cardescription,
                     "mileage": mileage,
                     "pickupdate": pickupdate_adbY, "pickuptime": SearchPickUpTimes, "dropofftime": SearchDropoffTimes,
                     "dropoffdate": dropoffdate_adbY, "price": price, "searchid": searchid_int, "imgurl": imgurl, "pickupstationid": pickupstationid[2:], "returnstationid": returnstationid[2:], "pickuptimes": SearchPickUpTimes, "dropofftimes": SearchDropoffTimes})
